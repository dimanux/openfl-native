...
class BitmapData implements IBitmapDrawable {
	...
	{
		lime_bitmap_data_reload(__handle, sourceBitmapData.__handle);
	}
	
	public function colorPadding()
	{
		lime_bitmap_data_color_padding(__handle);
	}
	#end
	...
	private static var lime_bitmap_data_color_padding = Lib.load("lime", "lime_bitmap_data_color_padding", 1);
	#end
